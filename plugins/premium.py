...
@Bot.on_message(filters.command('add_premium') & filters.user(OWNER_ID) & filters.private)
...
@Bot.on_message(filters.command('remove_premium') & filters.user(OWNER_ID) & filters.private)
...
@Bot.on_message(filters.command('list_premium') & filters.user(OWNER_ID) & filters.private)
