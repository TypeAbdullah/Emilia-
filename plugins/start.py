...
from bot import Bot
from config import ADMINS, FORCE_MSG, OWNER_ID, START_MSG, CUSTOM_CAPTION, DISABLE_CHANNEL_BUTTON, PROTECT_CONTENT, AUTO_DEL, DEL_TIMER, DEL_MSG, START_PIC, FORCE_PIC, SHORT_MSG
...
async def start_command(client: Client, message: Message):
    ...
    if len(text) > 7:
        ...
        is_user_pro = await is_premium(user_id)
