...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002060191103"))
...
#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://Makima:Makima@cluster0.lzlj5pf.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DB_NAME = os.environ.get("DATABASE_NAME", "Makima")

#force sub channel id, if you want enable force sub
FORCESUB_CHANNEL = int(os.environ.get("FORCESUB_CHANNEL", "-1002100615083"))
FORCESUB_CHANNEL2 = int(os.environ.get("FORCESUB_CHANNEL2", "-1002052977886"))
...
#Short Url or Api
SHORT_URL = os.environ.get("SHORTNER_URL", "kingurl.in")
SHORT_API = os.environ.get("SHORTNER_API", "8e922946e7021fad80ff62a604a507a240f4531e")
